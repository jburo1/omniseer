...
Modes:
  phase05  Start the selected real bringup in the background, then open keyboard teleop.
  smoke    Start the selected real bringup, run the passive verifier, then stop.
