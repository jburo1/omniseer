...
namespace robot_diag_control_cpp
{
  ...
  PlatformStatusSampler::PlatformStatusSampler(std::filesystem::path sys_root,
                                               std::filesystem::path proc_root,
                                               std::filesystem::path disk_path)
      : _sys_root(std::move(sys_root)), _proc_root(std::move(proc_root)),
  ...
  void PlatformStatusSampler::read_memory(uint64_t& used_bytes, uint64_t& total_bytes,
