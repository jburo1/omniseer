...
namespace robot_diag_control_cpp
{
  ...
  RobotGatewayService::RobotGatewayService(GatewayStateStore&     store,
                                           PreviewProcessManager& preview_manager)
      : _store(store), _preview_manager(preview_manager)
  {
  }
  ...
  RobotGatewayService::RobotGatewayService(GatewayStateStore&     store,
      ...
      : _store(store), _preview_manager(preview_manager), _teleop_manager(&teleop_manager)
  {
  }

  grpc::Status RobotGatewayService::GetSystemStatus(
      grpc::ServerContext* context, const gateway_proto::GetSystemStatusRequest* request,
      gateway_proto::SystemStatus* response)
  {
    (void) context;
    (void) request;
  ...
  grpc::Status RobotGatewayService::SetPreviewMode(
      grpc::ServerContext* context, const gateway_proto::SetPreviewModeRequest* request,
      gateway_proto::SetPreviewModeResponse* response)
  {
    ...
    if (request->enabled() && requested_profile != gateway_proto::PREVIEW_PROFILE_UNSPECIFIED &&
        !profile.has_value())
    {
  ...
  grpc::Status RobotGatewayService::SetTeleopEnabled(
      grpc::ServerContext* context, const gateway_proto::SetTeleopEnabledRequest* request,
  ...
  grpc::Status RobotGatewayService::SendTeleopCommand(
      grpc::ServerContext* context, const gateway_proto::SendTeleopCommandRequest* request,
      gateway_proto::SendTeleopCommandResponse* response)
  {
    ...
    const auto result = _teleop_manager->send_command(TeleopCommand{
  ...
  grpc::Status RobotGatewayService::GetOverlaySnapshot(
      grpc::ServerContext* context, const gateway_proto::GetOverlaySnapshotRequest* request,
