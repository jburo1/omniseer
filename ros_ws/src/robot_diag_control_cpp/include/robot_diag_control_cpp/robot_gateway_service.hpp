...
namespace robot_diag_control_cpp
{
  ...
  public:
    ...
    RobotGatewayService(GatewayStateStore& store, PreviewProcessManager& preview_manager,
    ...
    grpc::Status SetPreviewMode(grpc::ServerContext*                                context,
    ...
    grpc::Status SetTeleopEnabled(
        grpc::ServerContext* context, const omniseer::gateway::v1::SetTeleopEnabledRequest* request,
    ...
    grpc::Status GetOverlaySnapshot(grpc::ServerContext*                                    context,
