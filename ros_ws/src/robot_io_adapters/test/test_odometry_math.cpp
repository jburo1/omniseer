...
{
  const double angular_velocity = robot_io_adapters::counts_delta_to_wheel_angular_velocity(
...
TEST(OdometryMath, BodyTwistInverseMatchesFirmwareKinematics)
{
  ...
  const BodyTwist twist =
      robot_io_adapters::body_twist_from_wheel_angular_velocities(wheel_rates[0], wheel_rates[1],
                                                                  wheel_rates[2], wheel_rates[3],
                                                                  kWheelRadiusM, kHalfLengthM,
                                                                  kHalfWidthM);
