...
_REAL_ARGUMENT_DEFAULTS = [
    ...
    ("experiment_runtime_backend", ""),
    ("experiment_config", ""),
    ("experiment_container_image_id", ""),
    ("experiment_parameters", ""),
    ("experiment_model_family", ""),
    ("experiment_model_variant", ""),
    ("experiment_model_precision", ""),
    ("experiment_model_backend", ""),
    ("experiment_comparison_id", ""),
    ("experiment_trial", ""),
...
def _build_real_bringup_actions(*, pkg_bringup, config):
    ...
    experiment_recorder_node = Node(
        ...
        arguments=[
            ...
            "--model-family",
            config["experiment_model_family"],
            "--model-variant",
            config["experiment_model_variant"],
            "--model-precision",
            config["experiment_model_precision"],
            "--model-backend",
            config["experiment_model_backend"],
            "--detector-model-path",
            ...
            "--container-image-id",
            config["experiment_container_image_id"],
            "--launch-command",
            ...
            "--runtime-backend",
            config["experiment_runtime_backend"],
            "--experiment-config",
            config["experiment_config"],
            "--experiment-parameters",
            config["experiment_parameters"],
            "--comparison-id",
            config["experiment_comparison_id"],
            "--trial",
            config["experiment_trial"],
            "--workload-id",
            config["experiment_workload_id"],
            "--resolved-vision-config-path",
            config["resolved_vision_config_path"],
            "--system-interval-sec",
