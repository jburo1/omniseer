...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument('use_sim_time', default='true')
    ]
    ...
    slam_toolbox_node = Node(
        ...
        parameters=[ParameterFile(
            PathJoinSubstitution([pkg_bringup, 'config', config_file]),
            allow_substs=True
            ),
    ...
    return LaunchDescription(declared_arguments + [slam_toolbox_node])
