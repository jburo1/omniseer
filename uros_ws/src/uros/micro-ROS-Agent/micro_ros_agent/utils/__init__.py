...
from rosidl_adapter.parser import parse_message_file, parse_service_file, validate_field_types
...
def generate_XML(args):
    ...
    for idl_file in args["ros_interface_files"]:
        ...
        if extension == ".msg":
            ...
            os.path.join(srcs_dir, "%s_%s_%s.xml" % (spec.base_type.pkg_name, subfolder, spec.msg_name))
