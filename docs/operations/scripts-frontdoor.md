...
classes and a list of known-absent classes. Alternatively, `--objects` reads the study's
manual visibility-annotation syntax: `<class> start <inclusive-frame>`, `<class> end <inclusive-frame>`,
